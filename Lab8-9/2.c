...
int main() {
    ...
    printf("-------------------------------------------------\n");
    printf("     MONTHLY PAY CALCULATOR FOR EMPLOYEES         \n");
    printf("-------------------------------------------------\n");
    ...
    if (n < 1 || n > 100) {
        printf("\nInvalid number of employees! Please enter between 1 and 100.\n");
        return 0;
    }
    ...
    printf("-------------------------------------------------\n");
    printf("Thank you for using the Monthly Pay Calculator!\n");
